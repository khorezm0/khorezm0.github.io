...
var ASM_CONSTS = {
  3539404: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3539459: function($0) {performance.now = function() { return $0; };},  
 3539507: function($0) {performance.now = function() { return $0; };},  
 3539555: function() {performance.now = Module['emscripten_get_now_backup'];},  
 3539610: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3539671: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3539735: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _JsonDataReceived(methodName){
  		if(window.__jsonResponseReceived){
  			window.__jsonResponseReceived(UTF8ToString(methodName));
  		}
  	}

  function _LoadUrlExternal(url) {
  		window.location.href = UTF8ToString(url);
  	}

  function _SaveBinaryFile(dataBase64, fileName, projectId) {
  		if (window.__onUnityDiffuserSchemeSaved) {
  			window.__onUnityDiffuserSchemeSaved(
  				UTF8ToString(dataBase64),
  				UTF8ToString(fileName),
  				UTF8ToString(projectId)
  			);	
  		} else {
  			var a = document.createElement("a"); //Create <a>
  			a.href = "data:image/png;base64," + UTF8ToString(dataBase64); //Image Base64 Goes here
  			a.download = UTF8ToString(fileName); //File name Here
  			a.click(); //Downloaded file
  		}
  	}

  function _SaveTxtFile(file, fileName, projectId) {
  		if (window.__onUnityInsolSaved) {
  			window.__onUnityInsolSaved(
  				new Blob([UTF8ToString(file)], { type: "text/plain;charset=utf-8" }),
  				UTF8ToString(fileName),
  				UTF8ToString(projectId)
  			);
  		} else {
  			var a = document.createElement("a"); //Create <a>
  			a.href = URL.createObjectURL(new Blob([UTF8ToString(file)], { type: "text/plain;charset=utf-8" }));
  			a.download = UTF8ToString(fileName); //File name Here
  			a.click(); //Downloaded file
  		}
  	}
...
var asmLibraryArg = {
  ...
  "JsonDataReceived": _JsonDataReceived,
  "LoadUrlExternal": _LoadUrlExternal,
  "SaveBinaryFile": _SaveBinaryFile,
...
/** @type {function(...*):?} */
var dynCall_vfiffi = Module["dynCall_vfiffi"] = createExportWrapper("dynCall_vfiffi");
...
/** @type {function(...*):?} */
var dynCall_viffffiiiiii = Module["dynCall_viffffiiiiii"] = createExportWrapper("dynCall_viffffiiiiii");
...
/** @type {function(...*):?} */
var dynCall_viffifiiii = Module["dynCall_viffifiiii"] = createExportWrapper("dynCall_viffifiiii");
...
/** @type {function(...*):?} */
var dynCall_viiffifiiii = Module["dynCall_viiffifiiii"] = createExportWrapper("dynCall_viiffifiiii");
...
/** @type {function(...*):?} */
var dynCall_viiiffifiiii = Module["dynCall_viiiffifiiii"] = createExportWrapper("dynCall_viiiffifiiii");

/** @type {function(...*):?} */
var dynCall_viiifffifiiii = Module["dynCall_viiifffifiiii"] = createExportWrapper("dynCall_viiifffifiiii");

/** @type {function(...*):?} */
var dynCall_vifiiii = Module["dynCall_vifiiii"] = createExportWrapper("dynCall_vifiiii");

/** @type {function(...*):?} */
var dynCall_vfifiiii = Module["dynCall_vfifiiii"] = createExportWrapper("dynCall_vfifiiii");

/** @type {function(...*):?} */
var dynCall_vffifiiii = Module["dynCall_vffifiiii"] = createExportWrapper("dynCall_vffifiiii");

/** @type {function(...*):?} */
var dynCall_vfffifiiii = Module["dynCall_vfffifiiii"] = createExportWrapper("dynCall_vfffifiiii");

/** @type {function(...*):?} */
var dynCall_viffffifiiii = Module["dynCall_viffffifiiii"] = createExportWrapper("dynCall_viffffifiiii");

/** @type {function(...*):?} */
var dynCall_viiffffifiiii = Module["dynCall_viiffffifiiii"] = createExportWrapper("dynCall_viiffffifiiii");

/** @type {function(...*):?} */
var dynCall_viiiffffifiiii = Module["dynCall_viiiffffifiiii"] = createExportWrapper("dynCall_viiiffffifiiii");

/** @type {function(...*):?} */
var dynCall_vffffifiiii = Module["dynCall_vffffifiiii"] = createExportWrapper("dynCall_vffffifiiii");
